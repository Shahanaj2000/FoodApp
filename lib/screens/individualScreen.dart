                                      ...
                                      children: [
                                        ...
                                        const Padding(
                                          padding: EdgeInsets.symmetric(
                                              horizontal: 20),
                                          child: Text(
                                              "A flavorful Indian-inspired pizza topped with with homemade Tandoori Chicken. The chicken is spiced with tandoori masala and slightly charred in the oven, as if it came straight out of a tandoor! Top it with red onion and green pepper and it'll feel  like you're in your favorite uncle's backyard "),
                                        ),
                                        const SizedBox(
                                          height: 20,
                                        ),
                                  ...
                                  child: Align(
                                    ...
                                    child: ClipShadow(
                                      ...
                                      child: Container(
                                        ...
                                        width: 60,
                                        color: Colors.white,
                                        child: Image.asset(Helper.getAssetName("fav_filled.png", "virtual"),),
                                      ),
                                    ),
                                  ),
                                )
