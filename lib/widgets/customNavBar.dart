                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          menu
                              ...
                              : const Text("Menu", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w300),),
                        ],
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          offer
                              ? const Text("Offers",
                                  style: TextStyle(color: AppColor.orange))
                              : const Text("Offers",style: TextStyle(fontSize: 18, fontWeight: FontWeight.w300),),
                        ],
                      ),
                    ),
                    const SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          profile
                              ? const Text("Profile",
                                  style: TextStyle(color: AppColor.orange))
                              : const Text("Profile",style: TextStyle(fontSize: 18, fontWeight: FontWeight.w300),),
                        ],
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          more
                              ? const Text("Profile",
                                  style: TextStyle(color: AppColor.orange))
                              : const Text("More",style: TextStyle(fontSize: 18, fontWeight: FontWeight.w300),),
                        ],
                      ),
                    ),
                  ],
